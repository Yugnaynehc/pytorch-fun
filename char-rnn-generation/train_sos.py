...
from data import generate_training_data_sos, n_language, n_letters_sos
import time
...
for s in range(1, steps+1):
    ...
    if s % save_every == 0:
        torch.save(net, 'generator_sos.pt')
